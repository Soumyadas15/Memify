...
TimeSeriesCache::TimeSeriesCache(size_t max_size) : max_size_(max_size)
{
    ...
    file_logger_->info("Time series cache initialized with max size: " + std::to_string(max_size_));
    std::cout << "Time series cache initialized with max size: " << max_size_ << std::endl;
